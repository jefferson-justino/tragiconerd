...
import azul from '../mainComponents/main'
function Header() {
    return (
        <header >
            <section>
            ...
            <nav>
                <ul className={styles.list}>
                    <a href= {azul} target="_blank" rel="noreferrer" > <li className={styles.option}>SOBRE</li></a>
                    <a href="#jj" target="_blank" rel="noreferrer" > <li className={styles.option}>SETUP</li></a>
                    <a href="#jj" target="_blank" rel="noreferrer" > <li className={styles.option}>DOAR</li></a>
                </ul>
            </nav>
